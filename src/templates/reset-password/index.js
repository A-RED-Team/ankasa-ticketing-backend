                                                  ...
                                                  <tbody>
                                                      <tr>
                                                          <td style="width:200px;">
                                                              ...
                                                              <img height="auto" src="https://i.postimg.cc/DZb9Txj9/Ankasa.png"
                                      ...
                                      <tr>
                                          <td align="center"
                                              ...
                                              <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                  ...
                                                  <tr>
                                                      <td align="center" bgcolor="#2395FF" role="presentation"
                                                          style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;"
                                                          valign="middle">
                                                          <a href="${link}" style="text-decoration: none;">
                                                              <p
                                                                  style="background:#2395FF;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                                  Reset Password
                                                              </p>
                                                          </a>
                                                      </td>
